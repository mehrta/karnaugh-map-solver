...
namespace K_Analyzer
{
    public class CKarnaughTable : CMinterm
    {
        ...
        {
            SKarnaughGroup[] functionGroups = GetFunctionGroups();
            ...
            foreach (SKarnaughGroup group in functionGroups)
            {
        ...
        public EKarnaughTableType GetTableType()
        {
            return m_tableType;
        }
